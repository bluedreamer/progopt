...
boost::argsy::detail::utf8_codecvt_facet::utf8_codecvt_facet(
...
boost::argsy::detail::utf8_codecvt_facet::do_in(std::mbstate_t& /*state*/, const char* from, const char* from_end, const char*& from_next, wchar_t* to,
...
template<>
int boost::argsy::detail::get_cont_octet_out_count_impl<4>(wchar_t word){
   if (word < 0x80) {
      return 0;
   }
   if (word < 0x800) {
...
int boost::argsy::detail::utf8_codecvt_facet::get_cont_octet_out_count(
   wchar_t word
) const {
   return boost::argsy::detail::get_cont_octet_out_count_impl<sizeof(wchar_t)>(word);
}

std::codecvt_base::result
boost::argsy::detail::utf8_codecvt_facet::do_out(std::mbstate_t& /*state*/, const wchar_t* from, const wchar_t* from_end, const wchar_t*& from_next, char* to,
...
unsigned int boost::argsy::detail::utf8_codecvt_facet::get_octet_count(unsigned char lead_octet)
{
