...
*/
class detail_cmdline
{
public:
   // typedef command_line_style::style_t style_t;
   ...
   */
   detail_cmdline(const std::vector<std::string> &args);

   /** @overload */
   detail_cmdline(int argc, const char *const *argv);
