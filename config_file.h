...
/** Standalone parser for config files in ini-line format.
    ...
    - Section names are given in brackets.
     ...
     class.
 */
class common_config_file_iterator : public eof_iterator<common_config_file_iterator, option>
{
public:
...
private:
   ...
   [[nodiscard]] auto allowed_option(const std::string &s) const -> bool;
...
template<class charT>
basic_config_file_iterator<charT>::basic_config_file_iterator(std::basic_istream<charT> &is, const std::set<std::string> &allowed_options,
...
template<class charT>
auto basic_config_file_iterator<charT>::getline(std::string &s) -> bool
{
