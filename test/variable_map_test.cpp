...
void test_variable_map()
{
   ...
   desc.add_options()("foo,f", new untyped_value)("bar,b", po::value<string>())("biz,z", po::value<string>())("baz", new untyped_value())(
   ...
   int i;
   desc.add_options()("zee", bool_switch(), "")("zak", po::value<int>(&i), "")("opt", bool_switch(), "");
   ...
   desc2.add_options()("vee", po::value<string>()->default_value("42"))("voo", po::value<string>())("iii",
                                                                                                    po::value<int>()->default_value(123));
   ...
   desc3.add_options()("imp", po::value<int>()->implicit_value(100))("iim", po::value<int>()->implicit_value(200)->default_value(201))(
      "mmp,m", po::value<int>()->implicit_value(123)->default_value(124))("foo", po::value<int>());
...
{
   options_description desc;
   desc.add_options()("foo", new untyped_value())("bar", po::value<int>())("biz", po::value<vector<string>>())(
      "baz", po::value<vector<string>>()->multitoken())("int", po::value<vector<int>>()->notifier(&notifier));
   ...
   options.emplace_back("int", vector<string>(1, "13"));
   ...
   options.emplace_back("bar", vector<string>(1, "2"));
   variables_map vm3;
   ...
   options.emplace_back("int", vector<string>(1, "2 3"));
   variables_map vm4;
...
void test_priority()
{
   ...
   desc.add_options()
      ...
      ("second", po::value<vector<int>>()->default_value(vector<int>(1, 1), ""))("aux", po::value<vector<int>>())
...
void test_multiple_assignments_with_different_option_description()
{
   ...
   desc1.add_options()("help,h", "")("includes", po::value<vector<string>>()->composing(), "");
   ;
