...
auto from_8_bit_2(const std::string &s, const codecvt<wchar_t, char, mbstate_t> &cvt) -> std::wstring
{
   std::wstring result;
...
void test_convert(const std::string &input, const std::string &expected_output)
{
